...
"[project]/Documents/geometry_review/app/hooks/useUndoRedo.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useUndoRedo() {
    let maxHistorySize = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50;
    _s();
    const [history, setHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [currentIndex, setCurrentIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(-1);
    const lastSaveTimeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const canUndo = currentIndex > 0;
    const canRedo = currentIndex < history.length - 1;
    const saveState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUndoRedo.useCallback[saveState]": (objects, createdStack, description)=>{
            const now = Date.now();
            ...
            const newState = {
                id: "state_".concat(now, "_").concat(Math.random().toString(36).substr(2, 9)),
                timestamp: now,
            ...
            setHistory({
                "useUndoRedo.useCallback[saveState]": (prev)=>{
            ...
            }["useUndoRedo.useCallback[saveState]"]);
            setCurrentIndex({
                "useUndoRedo.useCallback[saveState]": (prev)=>{
    ...
    const undo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUndoRedo.useCallback[undo]": ()=>{
            if (!canUndo) return;
            setCurrentIndex({
                "useUndoRedo.useCallback[undo]": (prev)=>prev - 1
            }["useUndoRedo.useCallback[undo]"]);
        }
    }["useUndoRedo.useCallback[undo]"], [
        canUndo
    ]);
    const redo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUndoRedo.useCallback[redo]": ()=>{
            if (!canRedo) return;
            setCurrentIndex({
                "useUndoRedo.useCallback[redo]": (prev)=>prev + 1
            }["useUndoRedo.useCallback[redo]"]);
        }
    }["useUndoRedo.useCallback[redo]"], [
        canRedo
    ]);
    const clearHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUndoRedo.useCallback[clearHistory]": ()=>{
            setHistory([]);
            setCurrentIndex(-1);
        }
    }["useUndoRedo.useCallback[clearHistory]"], []);
    const getCurrentState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUndoRedo.useCallback[getCurrentState]": ()=>{
...
_s(useUndoRedo, "IVHdfZ1JXVKq5R2NBB1QrZ289DQ=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$app$2f$hooks$2f$useUndoRedo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/geometry_review/app/hooks/useUndoRedo.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function isValidPoint(o, brd) {
    return !!(o && o.elType === 'point' && typeof o.X === 'function' && typeof o.Y === 'function' && !Number.isNaN(o.X()) && !Number.isNaN(o.Y()) && (!brd || o.board === brd));
}
function GeneralGeometryTester() {
    ...
    const [selectedIds, setSelectedIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const { canUndo, canRedo, undo, redo, saveState, clearHistory, getCurrentState, currentIndex } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$app$2f$hooks$2f$useUndoRedo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUndoRedo"])(50);
    ...
    const selectedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(selectedIds);
    ...
    const pushCreated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GeneralGeometryTester.useCallback[pushCreated]": (obj)=>{
            if (obj === null || obj === void 0 ? void 0 : obj.id) {
                setCreatedStack({
                    "GeneralGeometryTester.useCallback[pushCreated]": (s)=>{
                        const newStack = [
                            ...s,
                            obj.id
                        ];
                        // Save state after each creation with proper object serialization
                        setTimeout({
                            "GeneralGeometryTester.useCallback[pushCreated]": ()=>{
                                if (boardRef.current) {
                                    const objects = Object.values(boardRef.current.objects).map({
                                        "GeneralGeometryTester.useCallback[pushCreated].objects": (o)=>{
                                            var _o_point1, _o_point2, _o_center, _o_radius;
                                            return {
                                                id: o.id,
                                                type: o.elType,
                                                name: o.name,
                                                visProp: o.visProp,
                                                position: o.elType === 'point' ? [
                                                    o.X(),
                                                    o.Y()
                                                ] : undefined,
                                                point1: o.elType === 'segment' || o.elType === 'line' ? {
                                                    id: (_o_point1 = o.point1) === null || _o_point1 === void 0 ? void 0 : _o_point1.id
                                                } : undefined,
                                                point2: o.elType === 'segment' || o.elType === 'line' ? {
                                                    id: (_o_point2 = o.point2) === null || _o_point2 === void 0 ? void 0 : _o_point2.id
                                                } : undefined,
                                                center: o.elType === 'circle' ? {
                                                    id: (_o_center = o.center) === null || _o_center === void 0 ? void 0 : _o_center.id
                                                } : undefined,
                                                radius: o.elType === 'circle' ? {
                                                    id: (_o_radius = o.radius) === null || _o_radius === void 0 ? void 0 : _o_radius.id
                                                } : undefined,
                                                _rawName: o._rawName
                                            };
                                        }
                                    }["GeneralGeometryTester.useCallback[pushCreated].objects"]);
                                    saveState(objects, newStack, "Created ".concat(obj.elType || 'object'));
                                }
                            }
                        }["GeneralGeometryTester.useCallback[pushCreated]"], 0);
                        return newStack;
                    }
                }["GeneralGeometryTester.useCallback[pushCreated]"]);
            }
                ...
                case 'segment':
                    {
                        ...
                        if (!isValidPoint(p)) p = createPointSmart(brd, xy);
                        if (!isValidPoint(p, brd)) {
                            setFeedback('Chyba při vytváření bodu');
                            break;
                        }
                        setSelectedIds({
                            "GeneralGeometryTester.useCallback[handleClick]": (prev)=>{
                                ...
                                // same point clicked twice → keep waiting for a distinct second point
                                if (arr[0] === arr[1]) {
                                    setFeedback('Vyberte jiný druhý bod');
                                    return [
                                        arr[0]
                                    ];
                                }
                                // resolve IDs to actual objects right before create
                                const p1 = brd.objects[arr[0]];
                                const p2 = brd.objects[arr[1]];
                                if (!isValidPoint(p1, brd) || !isValidPoint(p2, brd)) {
                                    setFeedback('Chyba: neplatné body pro úsečku');
                                    return [];
                                }
                                try {
                                    ...
                                    setFeedback('Chyba při vytváření úsečky');
                                }
                                return [];
                            }
                ...
                case 'line':
                    {
                        ...
                        setSelectedIds({
                            "GeneralGeometryTester.useCallback[handleClick]": (prev)=>{
                                ...
                                const p2 = brd.objects[arr[1]];
                                if (!isValidPoint(p1, brd) || !isValidPoint(p2, brd)) {
                                    setFeedback('Chyba: neplatné body pro přímku');
                                    return [];
                                }
                                try {
                                    ...
                                    setFeedback('Chyba při vytváření přímky');
                                }
                                return [];
                            }
                        }["GeneralGeometryTester.useCallback[handleClick]"]);
                ...
                case 'circle':
                    {
                        ...
                        setSelectedIds({
                            "GeneralGeometryTester.useCallback[handleClick]": (prev)=>{
                                ...
                                if (arr[0] === arr[1]) {
                                    setFeedback('Vyberte bod na kružnici odlišný od středu');
                                    return [
                                        arr[0]
                                    ];
                                }
                                ...
                                const p2 = brd.objects[arr[1]];
                                if (!isValidPoint(p1, brd) || !isValidPoint(p2, brd)) {
                                    setFeedback('Chyba: neplatné body pro kružnici');
                                    return [];
                                }
                                try {
                                    ...
                                    setFeedback('Chyba při vytváření kružnice');
                                }
                                return [];
                            }
                        }["GeneralGeometryTester.useCallback[handleClick]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GeneralGeometryTester.useEffect": ()=>{
            ...
            const downHandler = {
                "GeneralGeometryTester.useEffect.downHandler": (e)=>{
                    if (uiBusyRef.current) return;
            ...
            }["GeneralGeometryTester.useEffect.downHandler"];
            // 2) UP: if we armed a point and movement was small → open prompt
            const upHandler = {
                "GeneralGeometryTester.useEffect.upHandler": (e)=>{
                    const arm = renameArmRef.current;
                    if (!arm.pt) return;
            ...
            }["GeneralGeometryTester.useEffect.upHandler"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GeneralGeometryTester.useEffect": ()=>{
            ...
            // Clear current non-fixed objects
            const toRemove = [];
            ...
            toRemove.forEach({
                "GeneralGeometryTester.useEffect": (o)=>brd.removeObject(o)
            }["GeneralGeometryTester.useEffect"]);
            // Create a map to store restored objects by their original ID
            const restoredObjects = new Map();
            // First pass: restore all points
            currentState.objects.forEach({
                "GeneralGeometryTester.useEffect": (objData)=>{
                    var _objData_visProp;
                    if ((_objData_visProp = objData.visProp) === null || _objData_visProp === void 0 ? void 0 : _objData_visProp.fixed) return; // Skip fixed objects (givens)
                    if (objData.type === 'point') {
                        try {
                            const obj = brd.create('point', [
                                objData.position[0],
                                objData.position[1]
                            ], objData.visProp);
                            if (objData.name) obj.setAttribute({
                                name: objData.name
                            });
                            if (objData._rawName) obj._rawName = objData._rawName;
                            restoredObjects.set(objData.id, obj);
                        } catch (err) {
                            console.warn('Error restoring point:', err);
                        }
                    }
                }
            }["GeneralGeometryTester.useEffect"]);
            // Second pass: restore segments, lines, and circles using the restored points
            currentState.objects.forEach({
                "GeneralGeometryTester.useEffect": (objData)=>{
                    var _objData_visProp;
                    if ((_objData_visProp = objData.visProp) === null || _objData_visProp === void 0 ? void 0 : _objData_visProp.fixed) return; // Skip fixed objects (givens)
                    if (objData.type !== 'point') {
                        try {
                            ...
                            switch(objData.type){
                                case 'segment':
                                    var _objData_point1, _objData_point2;
                                    const segP1 = restoredObjects.get((_objData_point1 = objData.point1) === null || _objData_point1 === void 0 ? void 0 : _objData_point1.id);
                                    const segP2 = restoredObjects.get((_objData_point2 = objData.point2) === null || _objData_point2 === void 0 ? void 0 : _objData_point2.id);
                                    if (segP1 && segP2) {
                                        obj = brd.create('segment', [
                                            segP1,
                                            segP2
                                        ], objData.visProp);
                                    }
                                    break;
                                case 'line':
                                    var _objData_point11, _objData_point21;
                                    const lineP1 = restoredObjects.get((_objData_point11 = objData.point1) === null || _objData_point11 === void 0 ? void 0 : _objData_point11.id);
                                    const lineP2 = restoredObjects.get((_objData_point21 = objData.point2) === null || _objData_point21 === void 0 ? void 0 : _objData_point21.id);
                                    if (lineP1 && lineP2) {
                                        obj = brd.create('line', [
                                            lineP1,
                                            lineP2
                                    ...
                                    break;
                                case 'circle':
                                    var _objData_center, _objData_radius;
                                    const center = restoredObjects.get((_objData_center = objData.center) === null || _objData_center === void 0 ? void 0 : _objData_center.id);
                                    const radius = restoredObjects.get((_objData_radius = objData.radius) === null || _objData_radius === void 0 ? void 0 : _objData_radius.id);
                                    if (center && radius) {
                                        obj = brd.create('circle', [
                                            center,
                                            radius
                                        ], objData.visProp);
                                    }
                            ...
                            console.warn('Error restoring object:', err);
                        }
                    }
                }
            }["GeneralGeometryTester.useEffect"]);
            // Update created stack
            setCreatedStack(currentState.createdStack);
            setFeedback('');
            // Force board update
            brd.update();
        }
        ...
        currentIndex,
        getCurrentState
    ]); // Trigger when currentIndex changes
    function clearAll() {
        const brd = boardRef.current;
        if (!brd) return;
        const toRemove = [];
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: undoLast,
                                disabled: !canUndo,
                                className: "px-3 py-2 rounded bg-gray-700 text-white hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2",
                                title: "Zpět (Ctrl+Z)",
                                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: redoLast,
                                disabled: !canRedo,
                                className: "px-3 py-2 rounded bg-gray-600 text-white hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2",
                                title: "Znovu (Ctrl+Y)",
                                children: [
...
_s(GeneralGeometryTester, "o9kY9hIh8dnKvRCs0hJHeGnN6l8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$app$2f$hooks$2f$useUndoRedo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUndoRedo"]
    ];
});
...
//# sourceMappingURL=Documents_geometry_review_app_d54a417a._.js.map