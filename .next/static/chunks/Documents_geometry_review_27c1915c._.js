...
class UndoRedoManager {
    ...
    rollbackCreate(op) {
        ...
        if (obj) this.board.removeObject(obj);
                        ...
                        setSelected({
                            "GeneralGeometryTester.useCallback[handleClick]": (prev)=>{
                                ...
                                if (arr.length === 1) {
                                    ...
                                    const op = (_undoRedoRef_current = undoRedoRef.current) === null || _undoRedoRef_current === void 0 ? void 0 : _undoRedoRef_current.createLineOperation(p1, p2, attr);
                                    if (op) (_undoRedoRef_current1 = undoRedoRef.current) === null || _undoRedoRef_current1 === void 0 ? void 0 : _undoRedoRef_current1.pushOperation(op);
                        ...
                        setSelected({
                            "GeneralGeometryTester.useCallback[handleClick]": (prev)=>{
                                ...
                                if (arr.length === 1) {
                                    ...
                                    const op = (_undoRedoRef_current = undoRedoRef.current) === null || _undoRedoRef_current === void 0 ? void 0 : _undoRedoRef_current.createCircleOperation(center, on, attr);
                                    if (op) (_undoRedoRef_current1 = undoRedoRef.current) === null || _undoRedoRef_current1 === void 0 ? void 0 : _undoRedoRef_current1.pushOperation(op);
                ...
                case 'rubber':
                    {
                        ...
                        if (toRemove) {
                            ...
                            const delOp = (_undoRedoRef_current2 = undoRedoRef.current) === null || _undoRedoRef_current2 === void 0 ? void 0 : _undoRedoRef_current2.createDeleteOperation(toRemove);
                            if (delOp) {
                                var _undoRedoRef_current3;
                                (_undoRedoRef_current3 = undoRedoRef.current) === null || _undoRedoRef_current3 === void 0 ? void 0 : _undoRedoRef_current3.pushOperation(delOp);
