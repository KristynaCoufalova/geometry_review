...
function QuestionBasedTester(param) {
            ...
            const loadQuestion = {
                "QuestionBasedTester.useEffect.loadQuestion": async ()=>{
                    try {
                        ...
                        setError(null);
                        // Load question
                        const { data: questionData, error: questionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('gq_questions').select('*').eq('id', questionId).single();
                        ...
                        if (studentId === 'anonymous') {
                            const { data: userData, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id').eq('email', 'anonymous@example.com').single();
                        ...
                        // Create session
                        const { data: sessionData, error: sessionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('sessions').insert({
                            user_id: userId,
                        ...
                        // Create attempt
                        const { data: attemptData, error: attemptError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('gq_attempts').insert({
                            question_id: questionId,
    ...
    // Initialize board with question givens
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuestionBasedTester.useEffect": ()=>{
                    ...
                    if (givensData.circles) {
                        Object.entries(givensData.circles).forEach({
                            "QuestionBasedTester.useEffect": (param)=>{
                                ...
                                const center = givens[circleData.center] || brd.create('point', [
                                    circleData.center.x,
                                    circleData.center.y
                                ], {
                                ...
                                const circle = brd.create('circle', [
                                    center,
                                    circleData.radius
                                ], {
                                    strokeColor: '#000',
...
_s(QuestionBasedTester, "Z1Nr0zP0bgIOwNGcPDYi/q6yR3M=");
...
//# sourceMappingURL=Documents_geometry_review_06fdb7fe._.js.map