...
function GeometryConstructionTester() {
    ...
    const pushCreated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GeometryConstructionTester.useCallback[pushCreated]": (obj)=>{
            if (obj === null || obj === void 0 ? void 0 : obj.id) {
                setCreatedStack({
                    "GeometryConstructionTester.useCallback[pushCreated]": (s)=>{
                        const newStack = [
                            ...s,
                            obj.id
                        ];
                        ...
                        setTimeout({
                            "GeometryConstructionTester.useCallback[pushCreated]": ()=>{
                                if (boardRef.current) {
                                    const objects = Object.values(boardRef.current.objects).map({
                                        "GeometryConstructionTester.useCallback[pushCreated].objects": (o)=>{
                                    ...
                                    }["GeometryConstructionTester.useCallback[pushCreated].objects"]);
                                    saveState(objects, newStack, "Created ".concat(obj.elType || 'object'));
                                }
                            }
                        }["GeometryConstructionTester.useCallback[pushCreated]"], 0);
                        return newStack;
                    }
                }["GeometryConstructionTester.useCallback[pushCreated]"]);
            }
                ...
                case 'line':
                    {
                        ...
                        setSelected({
                            "GeometryConstructionTester.useCallback[handleClick]": (prev)=>{
                                ...
                                if (((_arr_ = arr[0]) === null || _arr_ === void 0 ? void 0 : _arr_.id) === ((_arr_1 = arr[1]) === null || _arr_1 === void 0 ? void 0 : _arr_1.id)) {
                                    setFeedback('Vyberte jiný druhý bod');
                                    return [
                                        arr[0]
                                    ];
                                }
                                if (!isValidPoint(arr[0], brd) || !isValidPoint(arr[1], brd)) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GeometryConstructionTester.useEffect": ()=>{
            ...
            // Clear current non-fixed objects (except givens)
            const toRemove = [];
            ...
            toRemove.forEach({
                "GeometryConstructionTester.useEffect": (o)=>brd.removeObject(o)
            }["GeometryConstructionTester.useEffect"]);
            ...
            currentState.objects.forEach({
                "GeometryConstructionTester.useEffect": (objData)=>{
                    var _objData_visProp;
                    if (((_objData_visProp = objData.visProp) === null || _objData_visProp === void 0 ? void 0 : _objData_visProp.fixed) || objData.name === 'S' || objData.name === 'C' || objData.name === 'q') {
                        return; // Skip fixed objects (givens)
                    }
...
_s(GeometryConstructionTester, "3g5rAkBDI37dzvpeW2e1LDQ8O9k=", false, function() {
    return [
...
//# sourceMappingURL=Documents_geometry_review_app_eba9fabd._.js.map