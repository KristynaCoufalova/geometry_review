        ...
        "GeneralGeometryTester.useEffect": ()=>{
            ...
            brd.on('down', {
                "GeneralGeometryTester.useEffect": (e)=>{
                    const under = brd.getAllObjectsUnderMouse(e);
                    const point = under.find({
                        "GeneralGeometryTester.useEffect.point": (o)=>{
                            var _o_visProp;
                            return o.elType === 'point' && !((_o_visProp = o.visProp) === null || _o_visProp === void 0 ? void 0 : _o_visProp.fixed);
                        }
                    }["GeneralGeometryTester.useEffect.point"]);
                    if (point) {
...
_s(GeneralGeometryTester, "43Y9H+UCeAcMmsElWd1VgWmCoMc=");
...
//# sourceMappingURL=Documents_geometry_review_app_bd715546._.js.map