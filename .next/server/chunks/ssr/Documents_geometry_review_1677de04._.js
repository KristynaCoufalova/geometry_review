...
class UndoRedoManager {
    ...
    ensurePoint(xy, attr = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DefaultPointAttrs"]) {
    ...
    createPointOperation(x, y, attr = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DefaultPointAttrs"]) {
        return {
            kind: 'create',
            elType: 'point',
            payload: {
...
class GridManager {
    ...
    setMode(mode) {
        ...
        switch(mode){
            case 'none':
                ...
                break;
            case 'major':
                this.createLineGrid(1.0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Colors"].grid.major, 1);
                this.applyDot(false);
                break;
            case 'minor':
                this.createLineGrid(0.2, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Colors"].grid.minor, 0.5);
                this.applyDot(false);
                break;
            case 'major-minor':
                this.createLineGrid(0.2, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Colors"].grid.minor, 0.5);
    ...
    applyDot(enabled) {
        ...
        this.container.style.backgroundImage = `radial-gradient(circle, ${__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Colors"].grid.dot} 1px, transparent 1px)`;
   ...
   */ getNearbyEps(gridMode, baseEps = 0.05) {
    ...
    point(x, y, snap = true, attrs = {}) {
        const pt = this.board.create('point', [
            ...
            ...__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DefaultPointAttrs"],
            snapToGrid: snap,
            snapSizeX: 0.5,
            snapSizeY: 0.5,
            ...attrs
   ...
   */ pointWithGrid(x, y, gridMode, attrs = {}) {
    ...
    segment(a, b, attrs = {}) {
        return this.board.create('segment', [
            ...
            ...__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DefaultGeometryAttrs"].segment,
            ...attrs
        });
    }
    line(a, b, attrs = {}) {
        return this.board.create('line', [
            ...
            ...__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DefaultGeometryAttrs"].line,
            ...attrs
        });
    }
    circle(center, on, attrs = {}) {
        return this.board.create('circle', [
            ...
            ...__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DefaultGeometryAttrs"].circle,
            ...attrs
        });
    }
...
function GeneralGeometryTester() {
    ...
    const getOrCreatePointViaHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((brd, xy)=>{
        ...
        const checkEPS = factory.getNearbyEps(gridOption, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EPS"]);
            ...
            case 'point':
                {
                    ...
                    const factory = geometryFactoryRef.current;
                    if (!factory) break;
                    const checkEPS = factory.getNearbyEps(gridOptionRef.current, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EPS"]);
                    const existing = factory.findNearbyPoint(snapped.x, snapped.y, checkEPS);
                    if (!existing) {
                        const attr = {
                            ...__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DefaultPointAttrs"]
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        undoRedoRef.current = new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$undo$2d$redo$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UndoRedoManager"]({
            ...
            EPS: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EPS"]
        });
        return ()=>{
            boardManager.free();
...
//# sourceMappingURL=Documents_geometry_review_1677de04._.js.map