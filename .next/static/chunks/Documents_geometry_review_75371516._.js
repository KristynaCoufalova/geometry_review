...
function serializeGeometry(obj) {
    const type = obj === null || obj === void 0 ? void 0 : obj.elType;
    if (type === 'point') {
        return {
            x: obj.X(),
            y: obj.Y()
...
function exportBoard(brd) {
    ...
    const snapshot = {
        ...
        boundingBoxCm: bbox,
        objects: Object.values(brd.objects).filter((obj)=>ALLOWED_TYPES.has(obj.elType)).map((obj)=>{
        ...
        }).filter(Boolean).filter((o)=>o.geometry !== null)
    };
    return snapshot;
}
function importBoard(brd, data) {
    var _brd_update;
    ...
    const applyAttrs = (el, src)=>{
        try {
            var _el_setAttribute, _el_setAttribute1;
            el === null || el === void 0 ? void 0 : (_el_setAttribute = el.setAttribute) === null || _el_setAttribute === void 0 ? void 0 : _el_setAttribute.call(el, {
                visible: true
            });
            const name = (src === null || src === void 0 ? void 0 : src.name) || '';
            el === null || el === void 0 ? void 0 : (_el_setAttribute1 = el.setAttribute) === null || _el_setAttribute1 === void 0 ? void 0 : _el_setAttribute1.call(el, {
                name,
                withLabel: !!name
            });
    ...
    // Points first
    for (const o of objs){
        if ((o === null || o === void 0 ? void 0 : o.type) === 'point') {
            const g = o.geometry;
            if ((g === null || g === void 0 ? void 0 : g.x) == null || (g === null || g === void 0 ? void 0 : g.y) == null) continue;
    ...
    // Segments and lines
    for (const o of objs){
        if ((o === null || o === void 0 ? void 0 : o.type) === 'segment' || (o === null || o === void 0 ? void 0 : o.type) === 'line') {
            const g = o.geometry;
            if (!(g && g.x1 != null && g.y1 != null && g.x2 != null && g.y2 != null)) continue;
            const a = brd.create('point', [
                g.x1,
                g.y1
            ], {
                name: '',
    ...
    // Circles
    for (const o of objs){
        if ((o === null || o === void 0 ? void 0 : o.type) === 'circle') {
            const g = o.geometry;
            if (!((g === null || g === void 0 ? void 0 : g.center) && (g === null || g === void 0 ? void 0 : g.radius) != null)) continue;
            const center = brd.create('point', [
                g.center.x,
                g.center.y
            ], {
                name: '',
    ...
    // Polygons
    for (const o of objs){
        if ((o === null || o === void 0 ? void 0 : o.type) === 'polygon') {
            const g = o.geometry;
            if (!((g === null || g === void 0 ? void 0 : g.vertices) && Array.isArray(g.vertices) && g.vertices.length >= 3)) continue;
            const vertices = g.vertices.map((v)=>brd.create('point', [
                    v.x,
                    v.y
                ], {
                    name: '',
...
function GeneralGeometryTester() {
            ...
            const interval = setInterval({
                "GeneralGeometryTester.useEffect.interval": ()=>{
                    ...
                    const serializeGeometry = {
                        "GeneralGeometryTester.useEffect.interval.serializeGeometry": (obj)=>{
                            ...
                            if (type === 'polygon') {
                                const verts = Array.isArray(obj.vertices) ? obj.vertices.map({
                                    "GeneralGeometryTester.useEffect.interval.serializeGeometry": (v)=>({
                                            x: v.X(),
                                            y: v.Y()
                                        })
                                }["GeneralGeometryTester.useEffect.interval.serializeGeometry"]) : [];
                                return {
                                    vertices: verts
                                };
                            }
    ...
    function loadConstruction() {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$geometry_review$2f$lib$2f$board$2d$serializer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["importBoard"])(brd, {
            objects: objs
        });
...
//# sourceMappingURL=Documents_geometry_review_75371516._.js.map